...
#         network.train()
#         im_u, k_u, mask, gnd = prepare_input_as_variable(batch,
#                                                          params.config.train.mask_seed,
#                                                          params.config.train.undersampling,
#                                                          params.config.train.equal_masks)
#
#         optimizer.zero_grad(set_to_none=True)
#         pred, full_iterations = network(im_u, k_u, mask, gnd)
#         # TODO: return full iterations
#         return pred, gnd
#
...
#     def run_validation():
#         evaluator.run(train_val_batcher.items_fold(0, 5, validation=True))
#
...
#         print('train')
#
#     trainer.run(train_val_batcher.items_fold(0, 5, validation=False), max_epochs=num_epochs)
#
#
#
#
...
#                 ssim_e = print_eoe(vis_e, epoch_dir, f'{name}_equal', validate_err, sequence_length, undersampling,
#                                    iters_e, iterations)
#                 ssim_ne = print_eoe(vis_ne, epoch_dir, f'{name}_nonequal', validate_err, sequence_length, undersampling,
#                                     iters_ne, iterations)
#
